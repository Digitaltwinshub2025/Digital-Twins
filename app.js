...
(function () {
  ...
  const FALLBACK_MEMBERS = [
    ...
    },
    {
      ...
      bio:
        "I am a multidisciplinary designer with academic training in Mechanical Design, Building Design & Environment. I hold Associate of Science degrees from Pasadena City College in Mechanical Design & Fabrication, Building Design & Environment, and Business Administration, combining technical design, spatial analysis, and international business knowledge.\n\nMy background bridges 3D modeling, BIM workflows, immersive visualization, and sustainability research allowing me to approach design from both technical and environmental perspectives.\n\nI am CSWA certified in SolidWorks and experienced in Rhino, Revit, Twinmotion, and Unreal Engine, applying these tools to site modeling, XR storytelling, and digital twin environments.\n\nThrough academic work and internships, including NASA NCAS, the ASU Reclamation Project, and a sustainability-focused internship aligned with USGBC principles, I have explored how design, immersive media, and environmental responsibility can work together to support resilient communities.\n\nBased in Los Angeles, my work is influenced by climate challenges, infrastructure systems, and public space dynamics. I am passionate about using emerging technology to create environmentally responsible and community-centered design solutions.",
      highlights: [
